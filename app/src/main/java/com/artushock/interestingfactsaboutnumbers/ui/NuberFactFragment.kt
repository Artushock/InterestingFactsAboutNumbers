 ...
 * Use the [NuberFactFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class NuberFactFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment NuberFactFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            NuberFactFragment().apply {
